...
ifdef LINUX
	...
	CFLAGS = -Os -O2 -fPIC -lpthread -Ilibs/ -Ilibs/glm -Ilibs/glm/glm -Isrc -std=c++17 -Wno-everything -Llibs/glm/build/ -lglm_static
...
bin/gltst: bin/glTest.o bin/Mesh.o bin/Physics.o
	$(CC) $(OPENCV_LIBS) $(CFLAGS) $(GLFLAGS) $(ASSIMP) $(LDFLAGS) $(PHYSX) src/rendering/RenderTarget.cpp src/utils/controls.cpp src/rendering/Shader.cpp src/rendering/Texture.cpp bin/Physics.o bin/ShaderUtils.o bin/glTest.o bin/Mesh.o -o bin/gltst
